...
namespace Latihan_Inheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Owen Wright", 20);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("komarudin", 25, 12345, "pemrogaman");
            teacher.GetNameAndAge();

            Student student = new Student("Lakey", 19, 2675, "lakey.2802@students.amikom.ac.id");
